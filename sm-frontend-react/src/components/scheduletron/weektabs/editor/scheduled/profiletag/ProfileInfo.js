...
class ProfileInfo extends Component {
  ...
  render() {
    ...
    return (
      <div style = {{minHeight :20, background : '#F0F0F0', display : 'flex', flexDirection : 'column'}}>
      ...
      >
        <img style = {{transitionDuration : '.3s', transform : expanded ? 'rotate(180deg)' : 'rotate(0deg'}} src={expandIcon} />
      </Button>
      </div>
